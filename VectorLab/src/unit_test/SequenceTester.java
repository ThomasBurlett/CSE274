...
public class SequenceTester {
	...
	private Sequence create_sequence(int n) {
		Sequence S = new StringVector();  // Specifies which Sequence structure is being used.
		for (int i=0; i < n; i++) {
			S.push_back("" + i);
		}

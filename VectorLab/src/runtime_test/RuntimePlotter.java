...
public class RuntimePlotter {
	...
	static void plot_get() {
		...
		for (int n = 1; n < 500; n++) { // For problem sizes ranging from 1 to
										// 500:
			...
			C.add_point(n, S.numOps(), "blue"); // Plot the number of ops that
												// get required
		}
	...
	static void plot_set() {
		...
		for (int n = 1; n < 500; n++) {
			// TO DO: Plot the number of ops requires to set element n/2 in a
			// sequence
	...
	static void plot_single_push_back() {
		...
		for (int n = 0; n < 500; n++) {
			...
			S.resetOps();
			S.push_back("0");
			C.add_point(n, S.numOps(), "blue"); // Plot number of ops push_back
												// required
		}
	...
	static void plot_single_push_front() {
		...
		for (int n = 0; n < 500; n++) {
			// TO DO: Plot number of ops required to push_front onto a sequence
			// of
	...
	static void plot_multi_push_back() {
		...
		for (int n = 0; n < 500; n++) {
			...
			C.add_point(n, S.numOps(), "blue"); // Plot number of ops its taken,
												// in total,
